<%-- 
    ...
    Created on : Mar 28, 2015, 9:05:24 PM
    Author     : yanyanzhou
--%>
...
<%
    ...
    ResultSet rst = (ResultSet) session.getAttribute("cart");
%>
...
<html>
    <head>
        ...
        <title>Online Bookstore Shopping Cart Page</title>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="CommodityManager?command=showCart">Shopping Cart</a></li>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div class="col-sm-3">
                        <button type="submit" class="btn-primary btn-block">
                            <a href="CommodityManager?command=pay&user=<%=user%>">
                                Check out
                            </a>
                        </button>
                    </div><div class="col-sm-3">
                        <button type="submit" class="btn-primary btn-block">
                            <a href="CommodityManager?command=home">
                                Continue Shopping
                            </a>
                        </button>
                    </div>
